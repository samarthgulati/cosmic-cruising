...
THREEx.Planets.createSun	= function(){
	...
	var texture	= textureLoader.load(THREEx.Planets.baseURL+'images/sunmap.jpg')
...
THREEx.Planets.createMercury	= function(){
	var geometry	= new THREE.SphereGeometry(0.5, 32, 32)
	var material	= new THREE.MeshPhongMaterial({
		map	: textureLoader.load(THREEx.Planets.baseURL+'images/mercurymap.jpg'),
		bumpMap	: textureLoader.load(THREEx.Planets.baseURL+'images/mercurybump.jpg'),
		bumpScale: 0.005,
	})
	var mesh	= new THREE.Mesh(geometry, material)
	return mesh	
...
THREEx.Planets.createVenus	= function(){
	var geometry	= new THREE.SphereGeometry(0.5, 32, 32)
	var material	= new THREE.MeshPhongMaterial({
		map	: textureLoader.load(THREEx.Planets.baseURL+'images/venusmap.jpg'),
		bumpMap	: textureLoader.load(THREEx.Planets.baseURL+'images/venusbump.jpg'),
		bumpScale: 0.005,
	})
	var mesh	= new THREE.Mesh(geometry, material)
	return mesh	
...
THREEx.Planets.createEarth	= function(scale){
	var geometry	= new THREE.SphereGeometry(0.5, 64, 64)
	var material	= new THREE.MeshPhongMaterial({
		// map		: textureLoader.load(THREEx.Planets.baseURL+'images/earthmap1k.jpg'),
		// bumpMap		: textureLoader.load(THREEx.Planets.baseURL+'images/earthbump1k.jpg'),
		map		: textureLoader.load(THREEx.Planets.baseURL+'images/planetmap.jpg'),
		bumpMap		: textureLoader.load(THREEx.Planets.baseURL+'images/planetbump.jpg'),
		bumpScale	: 0.05 * scale,
		// specularMap	: textureLoader.load(THREEx.Planets.baseURL+'images/earthspec1k.jpg'),
...
THREEx.Planets.createEarthCloud	= function(){
	...
	var geometry	= new THREE.SphereGeometry(0.51, 64, 64)
	var material	= new THREE.MeshPhongMaterial({
...
THREEx.Planets.createMars	= function(){
	var geometry	= new THREE.SphereGeometry(0.5, 32, 32)
	var material	= new THREE.MeshPhongMaterial({
		map	: textureLoader.load(THREEx.Planets.baseURL+'images/marsmap1k.jpg'),
		bumpMap	: textureLoader.load(THREEx.Planets.baseURL+'images/marsbump1k.jpg'),
		bumpScale: 0.05,
	})
	var mesh	= new THREE.Mesh(geometry, material)
	return mesh	
...
THREEx.Planets.createJupiter	= function(){
	var geometry	= new THREE.SphereGeometry(0.5, 32, 32)
	var texture	= textureLoader.load(THREEx.Planets.baseURL+'images/jupitermap.jpg')
	var material	= new THREE.MeshPhongMaterial({
		map	: texture,
		bumpMap	: texture,
		bumpScale: 0.02,
...
THREEx.Planets.createSaturn	= function(){
	var geometry	= new THREE.SphereGeometry(0.5, 32, 32)
	var texture	= textureLoader.load(THREEx.Planets.baseURL+'images/saturnmap.jpg')
	var material	= new THREE.MeshPhongMaterial({
		map	: texture,
		bumpMap	: texture,
		bumpScale: 0.05,
...
THREEx.Planets.createSaturnRing	= function(){
	...
	var material	= new THREE.MeshPhongMaterial({
		map		: new THREE.Texture(canvasResult),
		// map		: textureLoader.load(THREEx.Planets.baseURL+'images/ash_uvgrid01.jpg'),
		side		: THREE.DoubleSide,
		transparent	: true,
		opacity		: 0.8,
	})
...
THREEx.Planets.createUranus	= function(){
	var geometry	= new THREE.SphereGeometry(0.5, 32, 32)
	var texture	= textureLoader.load(THREEx.Planets.baseURL+'images/uranusmap.jpg')
	var material	= new THREE.MeshPhongMaterial({
		map	: texture,
		bumpMap	: texture,
		bumpScale: 0.05,
...
THREEx.Planets.createNeptune	= function(){
	var geometry	= new THREE.SphereGeometry(0.5, 32, 32)
	var texture	= textureLoader.load(THREEx.Planets.baseURL+'images/neptunemap.jpg')
	var material	= new THREE.MeshPhongMaterial({
		map	: texture,
		bumpMap	: texture,
		bumpScale: 0.05,
...
THREEx.Planets.createPluto	= function(){
	var geometry	= new THREE.SphereGeometry(0.5, 32, 32)
	var material	= new THREE.MeshPhongMaterial({
		map	: textureLoader.load(THREEx.Planets.baseURL+'images/plutomap1k.jpg'),
		bumpMap	: textureLoader.load(THREEx.Planets.baseURL+'images/plutobump1k.jpg'),
		bumpScale: 0.005,
	})
	var mesh	= new THREE.Mesh(geometry, material)
	return mesh	
...
THREEx.Planets.createStarfield	= function(){
	var texture	= textureLoader.load(THREEx.Planets.baseURL+'images/galaxy_starfield.png')
